          ...
          <div className="w-2/3 bg-white rounded-lg shadow dark:border md:mt-4 sm:max-w-md xl:p-0 bg-white mt-4 mx-16 ">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                ...
                <button type="submit" className="w-full text-black hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 bg-blue-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Se connecter</button>
                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                      Pas encore de compte ? <a href="#" className="font-medium text-primary-600 text-black hover:underline">S'inscrire</a>
                </p>
              </form>
            </div>
          </div>
