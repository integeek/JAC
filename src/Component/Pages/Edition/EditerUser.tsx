              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">  
                    ...
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Editer le nom de l'utilisateur</h3>
                    <div className="mt-2">
                    ...
                    <h3 className="mt-6 text-lg leading-6 font-medium text-gray-900">Editer le prénom de l'utilisateur</h3>
                    <div className="mt-2">
                    ...
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Editer l'email de l'utilisateur</h3>
                    <div className="mt-2">
                    ...
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Editer le rôle de l'utilisateur</h3>
                    <div className="mt-2">
