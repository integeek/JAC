          ...
          <div className="flex flex-wrap items-center sm:-mx-3">
            <div className="col-span-1  md:w-1/2 justify-left" id="texte">
              <div className="pb-6">
                ...
                <p className="mx-auto mb-8 text-base text-gray-500">Cela n'a jamais été aussi facile de réserver ses repas</p>
                <div className="relative flex flex-row ">
                  <Link to="/connexion" className="flex items-center px-6 py-3 m-5 mb-3 text-lg text-white bg-indigo-600 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
                    Se connecter 
                  ...
                  <Link to="/inscription" className="flex items-center px-6 py-3 m-5 mb-3 text-lg text-white bg-gray-400 rounded-md hover:bg-black hover:bg-opacity-75">
                    Créer un compte 
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 ml-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <line x1="5" y1="12" x2="19" y2="12"></line>
                      <polyline points="12 5 19 12 12 19"></polyline>
            ...
            <div className="justify-end col-span-1 md:w-1/2 " id="image">
              <div className="h-auto overflow-hidden rounded-md shadow-xl md:justify-end sm:rounded-xl">
                <img src="https://lepetitjournal.com/sites/default/files/styles/main_article/public/2022-04/Farandole-plat-restaurant-francais-Le-Crystal.jpg?itok=NluTgo1V" alt="" className="object-cover w-full h-full"/>
              </div>
            </div>
          </div>
        </div>
